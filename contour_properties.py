...
for c in cnts:
    # compute the moments of the contour which cna be used to compute the
...
for c in cnts:
    #fit a rotated bounding box to the contour and draw  rotated box
...
for c in cnts:
    # to fit an ellipse our contour mst have at least 5 points
    if len(c) >= 5:
